...
public class HeadRotation : MechComponent
{
	...
	public void RunComponent()
	{
		...
		targetRotation.x += lookHorzInput * energyManager.energies[HELM_INDEX] * Time.deltaTime * 100f;
		targetRotation.y += lookVertInput * energyManager.energies[HELM_INDEX] * Time.deltaTime * 100f;
