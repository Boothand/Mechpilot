...
public class ArmBlockState : MechComponent
{
	...
	public Vector3 BlockPos()
	{
		...
		rArmPos += inputVec * speedToUse * Time.deltaTime * energyManager.energies[WEAPONOFFICER_INDEX] * scaleFactor;
	...
	public Quaternion ArmSideRotation()
	{
		...
		{
			sideTargetAngle += factor * rotationInput * Time.deltaTime * rotationSpeed * energyManager.energies[WEAPONOFFICER_INDEX];
		}
